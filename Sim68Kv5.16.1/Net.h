...
int netSendData(char *data, unsigned int &size, char *remoteIP, USHORT port); // sends network data
int netReadData(char *data, unsigned int &size, char *senderIP, USHORT &port); // returns network data
int netCloseSockets();
